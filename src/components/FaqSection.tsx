...
import { Users, Trophy, CalendarCheck, Shirt, MapPin, Clock } from "lucide-react";
...
const faqs: FaqItem[] = [
  {
    ...
    answer: "Anyone who are in 1st to 3rd year of their undergraduate studies in any discipline can participate. We welcome students from all backgrounds and skill levels to join the fun!",
  ...
  },
  {
    ...
    answer: "All events will be held at the Reva University campus. Detailed venue information will be shared with registered participants.",
    ...
    <section id="faq" className="py-20 bg-darkAccent relative">
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 reveal">
          <div className="inline-block px-3 py-1 mb-6 font-squid bg-white/5 rounded-full border border-white/10 text-squidPink text-sm">
            GOT QUESTIONS?
          </div>
          
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-squid font-bold mb-6 text-white">
